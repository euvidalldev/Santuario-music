...
export function AudioPlayer() {
  ...
  return (
    <>
      ...
      {/* ── Mobile player (below bottom nav) ── */}
        ...
        <div className="flex items-center gap-3 px-4 py-2">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            <button
              ...
              className="w-9 h-9 flex items-center justify-center bg-primary text-primary-foreground rounded-full shadow-[0_0_12px_rgba(200,80,0,0.3)] active:scale-95 transition-all"
            >
